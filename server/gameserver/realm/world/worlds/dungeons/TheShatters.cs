...
namespace LoESoft.GameServer.realm.world
{
    public class TheShatters : World
    {
        ...
        {
            return GameServer.Manager.AddWorld(new TheShatters());
        }
        ...
        public void CloseBridge1()
        {
            ...
            foreach (var p in Players)
            {
                for (int i = 138; i < 152; i++)
                {
                    ...
                    tile.TileId = GameServer.Manager.GameData.IdToTileType["shtrs Pure Evil"];
            ...
            foreach (var p in Players)
            {
                for (int x = 174; x < 200; x++)
                {
                    for (int y = 162; y < 181; y++)
                    {
                        ...
                        tile.TileId = GameServer.Manager.GameData.IdToTileType["shtrs Bridge"];
