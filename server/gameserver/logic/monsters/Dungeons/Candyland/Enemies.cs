    ...
    partial class BehaviorDb
    {
        ...
        .Init("MegaRototo",
            new State(
                ...
                new State("1",
                    new Wander(5),
                    new Shoot(10, 4, shootAngle: 90, index: 0, coolDownOffset: 500),
                    new Shoot(10, 4, shootAngle: 90, index: 1, angleOffset: 45, coolDownOffset: 1000),
                    new TimedTransition(4000, "2")
                    ),
                new State("2",
                    new Shoot(10, 2, shootAngle: 10, index: 2, coolDown: 50),
                    new Shoot(10, 1, index: 3, coolDown: 50),
            ...
            .Init("Spoiled Creampuff",
                new State(
                    new Wander(5),
                    new Shoot(20, 2, 40, angleOffset: 60 / 3, index: 0, coolDown: 1500),
                    new Shoot(20, 4, 15, angleOffset: 40 / 3, index: 1, coolDown: 1000),
            ...
            .Init("Desire Troll",
                new State(
                    ...
                    new Shoot(15, 3, 5, angleOffset: 30 / 3, index: 0, coolDown: 2100),
                    new Shoot(15, 5, 10, angleOffset: 60 / 3, index: 2, coolDown: 1950),
        ...
        .Init("Swoll Fairy",
            new State(
                ...
                new State("1",
                    new Wander(3),
                    new Shoot(10, 2, shootAngle: 30, index: 0, coolDown: 50),
                    new TimedTransition(4000, "2")
                    ),
                new State("2",
                    new Wander(3),
                    new Shoot(10, 8, shootAngle: 45, index: 1, angleOffset: 0, coolDown: 100),
                    new TimedTransition(4000, "1")
                    )
                ),
                new Threshold(0.01,
            ...
            .Init("Gigacorn",
                new State(
                    ...
                    new Shoot(20, 1, 40, angleOffset: 60 / 3, index: 0, coolDown: 2100),
                    new Shoot(20, 1, 40, angleOffset: 60 / 3, index: 0, coolDown: 2200),
                    new Shoot(20, 1, 40, angleOffset: 60 / 3, index: 0, coolDown: 2300),
                    new Shoot(20, 1, 40, angleOffset: 60 / 3, index: 0, coolDown: 2400),
                    new Shoot(20, 3, 15, angleOffset: 40 / 3, index: 1, coolDown: 4000),
        ...
        .Init("Cupcake",
            new State(
                new Shoot(10, 8, shootAngle: 45, index: 0, angleOffset: 0, coolDown: 1000)
                ),
            new Threshold(0.01,
        ...
        .Init("Fairy",
            new State(
                new Wander(3),
                new Shoot(10, 2, shootAngle: 30, index: 0, coolDown: 500)
                )
            )
        .Init("Wishing Troll",
            new State(
        ...
        .Init("Big Creampuff",
            new State(
                new Wander(5),
                new Shoot(20, 1, 0, angleOffset: 40 / 3, index: 0, coolDown: 1000),
        ...
        .Init("Small Creampuff",
            new State(
                new Wander(5),
                new Shoot(20, 3, 30, angleOffset: 40 / 3, index: 1, coolDown: 1400)
                )
            )
        .Init("Tiny Rototo",
            new State(
