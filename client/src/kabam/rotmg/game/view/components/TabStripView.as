...
public class TabStripView extends Sprite {
    ...
    public function drawBackground():void {
        ...
        this.background.filters = [TextureRedrawer.OUTLINE_FILTER];
    ...
    public function addTab(_arg1:*, _arg2:Sprite):void {
        ...
        if ((_arg1 is Bitmap)) {
            _local4 = addIconTab(_local3, (_arg1 as Bitmap));
        }
        else {
            if ((_arg1 is BaseSimpleText)) {
                _local4 = addTextTab(_local3, (_arg1 as BaseSimpleText));
            }
        }
        _local4.filters = [TextureRedrawer.OUTLINE_FILTER];
    ...
    private static function addIconTab(_arg1:int, _arg2:Bitmap):TabIconView {
    ...
    private static function addTextTab(_arg1:int, _arg2:BaseSimpleText):TabTextView {
        var _local3:Sprite = new TabBackground();
