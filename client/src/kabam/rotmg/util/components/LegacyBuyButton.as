...
public class LegacyBuyButton extends BuyButton {
    ...
    public static const empiresCoin:BitmapData = IconFactory.makeEmpiresCoin();
    ...
    public function LegacyBuyButton(_arg1:String, _arg2:int, _arg3:int, _arg4:int, _arg5:Boolean = false, _arg6:Boolean = false, _arg7:Boolean = false, _arg8:String = "Add to Cart") {
        ...
        if (_arg7) {
            this.extraInfo = true;
            this.gameStoreText = new TextFieldDisplayConcrete().setSize(_arg2 * 0.8).setColor(0x363636).setBold(true);
            this.waiter.push(this.gameStoreText.textChanged);
            var _embeddedText:StringBuilder = this.staticStringBuilder.setString(_arg8);
            this.gameStoreText.setStringBuilder(_embeddedText);
            addChild(this.gameStoreText);
        }
    ...
    public var gameStoreText:TextFieldDisplayConcrete;
    public var icon:Bitmap;
    public var price:int = -1;
    public var currency:int = -1;
    public var _width:int = -1;
    private var extraInfo:Boolean = false;
    ...
    private function updateIcon():void {
        switch (this.currency) {
            ...
            case Currency.FORTUNE:
                ...
                break;
            case Currency.EMPIRE_COIN:
                this.icon.bitmapData = empiresCoin;
                break;
            default:
    ...
    private function updateText():void {
        ...
        if (this.extraInfo) {
            this.gameStoreText.x = (this.getWidth() - this.icon.width / 2 - this.gameStoreText.width - PADDING) * 0.5;
            this.gameStoreText.y = this.textVertMargin + 16;
        }
    }
    ...
    private function getHeight():int {
        return ((((this.fixedHeight) != -1) ? this.fixedHeight : (this.text.height + (this.textVertMargin * 2)) + (this.extraInfo ? 12 : 0)));
    }
