...
import kabam.rotmg.application.impl.LoERealmSetup;
import kabam.rotmg.application.impl.LoERealmTestSetup;
...
public class ApplicationConfig implements IConfig {
    ...
    private function makeTestingSetup():ApplicationSetup {
        ...
        switch (_local1) {
            ...
            case BuildEnvironment.LOEREALM:
                return new LoERealmSetup();
            case BuildEnvironment.LOEREALMTEST:
                return new LoERealmTestSetup();
            default:
