...
public class IconFactory {
    ...
    public static function makeEmpiresCoin():BitmapData {
        var _local1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiInterfaceBig", 31), null, 24, true, 0, 0);
        return (cropAndGlowIcon(_local1));
    }

    public static function makeCoin(_arg1:int = 40):BitmapData {
        var _local1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 225), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local1));
    }
    ...
    public static function makeFame(_arg1:int = 40):BitmapData {
        var _local1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 224), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local1));
    }
