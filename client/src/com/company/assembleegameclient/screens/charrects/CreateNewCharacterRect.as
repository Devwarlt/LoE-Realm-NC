...
public class CreateNewCharacterRect extends CharacterRect {
    ...
    public function CreateNewCharacterRect(_arg1:PlayerModel) {
        ...
        super.init();
        this.makeBitmap();
        if ((_arg1.getNumStars() != FameUtil.maxStars()) && (Player.accountType_ <= 1)) {
            _local2 = (FameUtil.maxStars() - _arg1.getNumStars());
            super.makeTagline(new LineBuilder().setParams(TextKey.CREATE_NEW_CHARACTER_RECT_TAGLINE, {"remainingStars": _local2}));
    ...
    public function makeBitmap():void {
        ...
        this.bitmap_.scaleX = this.bitmap_.scaleY *= 0.75;
        this.bitmap_.x = 4;
        this.bitmap_.y = 4;
