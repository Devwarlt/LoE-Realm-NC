...
public class NexusBackground extends Background {
    ...
    override public function draw(_arg1:Camera, _arg2:int):void {
        ...
        var _local5:Vector.<Number> = (this.path_.data as Vector.<Number>);
        _local5.push(
                _local4.left,
                _local4.top,
                _local4.right,
...
class Island {
    ...
    public function draw(_arg1:Camera, _arg2:int, _arg3:Vector.<IGraphicsData>):void {
        ...
        var _local10:Vector.<Number> = (this.path_.data as Vector.<Number>);
        _local10.push(
                _local8.x,
                _local8.y,
                _local9.x,
