...
public class EquipmentTile extends InteractiveItemTile {
    ...
    public function setType(_arg1:int):void {
        ...
        if (_local2 != null) {
            ...
            this.backgroundDetail.x = BORDER + this.backgroundDetail.width / 2;
            this.backgroundDetail.y = BORDER + this.backgroundDetail.height / 2;
            this.backgroundDetail.scaleX = this.backgroundDetail.scaleY = 3;
