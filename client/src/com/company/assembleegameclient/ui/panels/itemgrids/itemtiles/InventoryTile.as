...
public class InventoryTile extends InteractiveItemTile {
    ...
    public function addTileNumber(_arg1:String):void {
        this.hotKey = _arg1;
        this.buildHotKeyBMP();
    }
    ...
    public function buildHotKeyBMP():void {
        ...
        var _local2:BitmapData = _local1.make(new StaticStringBuilder(this.hotKey), 10, 0x363636, true, IDENTITY_MATRIX, false);
        this.hotKeyBMP = new Bitmap(_local2);
        this.hotKeyBMP.x = ((WIDTH / 2) - (this.hotKeyBMP.width / 2));
        this.hotKeyBMP.y = ((HEIGHT / 2) - (this.hotKeyBMP.height / 2));
