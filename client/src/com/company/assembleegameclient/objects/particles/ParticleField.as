...
public class ParticleField extends BitmapParticle {
    ...
    public function ParticleField(_arg1:Number, _arg2:Number) {
        ...
        this.setBitmapSize();
        this.createTimer();
        var _local3:BitmapData = new BitmapData(this.width_, this.height_, true, 0);
    ...
    private function setDimensions(_arg1:Number, _arg2:Number):void {
        ...
        this.width_ = ((_arg2 * 5) + 40);
        this.height_ = (this.visibleHeight + this.offset);
    }

    private function setBitmapSize():void {
        this.bitmapSize = (((this.width_ == 8)) ? this.SMALL : this.LARGE);
    }
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        _bitmapData = new BitmapData(this.width_, this.height_, true, 0);
    ...
    private function getEndPoint():Point {
        return (new Point((this.width_ / 2), (this.visibleHeight / 2)));
    }
...
class Square extends Shape {
    ...
    internal var lifespan:uint;
    internal var moveX:Number;
    internal var moveY:Number;
